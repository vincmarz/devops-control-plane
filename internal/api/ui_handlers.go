...
func (h *Handler) uiApplications(w http.ResponseWriter, r *http.Request) {
	...
	h.renderUI(w, http.StatusOK, uiData{Title: "Applications", Subtitle: "Argo CD applications observed by the Control Plane", Active: "applications", Applications: apps, Changes: changes, Stats: buildUIStats(changes, apps, nil)})
}
